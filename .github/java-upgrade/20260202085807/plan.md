...
## Project Information
- **Project path**: d:\Java\Java-fundamentals\Java-Fundamentals
- **Working branch**: appmod/java-upgrade-20260202085807
...
- **Build tool path**: C:\Program Files\apache-maven-3.9.12\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260202085807`.
